...
import TagInput from "@/components/publicComponents/TagInput.vue";
import {getSkusList,createSkus,updateSkus,deleteSkus,updateSkusStatus} from "@/api/suks"
...
<template>
    <el-card shadow="never" class="border-0">
      ...
      <el-table ref="multipleTableRef" @selection-change="handleSelectionChange" :data="tableData" stripe
        ...
        <el-table-column label="操作" width="250" align="center">
          <template #default="scope">
            ...
            <el-popconfirm title="是否删除规格？" confirmButtonText="确认" cancelButtonText="取消"
      ...
      <FormDrawer destroyOnClose ref="formDrawerRef" :title="drawerTitle" @submit="handleSubmit" confirm-text="提交">
