...
const openSetRule = (row:any) => {
    ...
    getRuleList(1).then(res => {
        ruleList.value = (res as any).list
        defaultExpandedKeys.value = (res as any).list.map((o:any) => o.id);
...
const handleTreeCheck = (...e:any[]) => {
    ...
    (ruleIds as any).value = [...checkedKeys, ...halfCheckedKeys];
}
...
<template>
    <el-card shadow="never" class="border-0">
        ...
        <el-table :data="tableData" stripe style="width: 100%" v-loading="loading">
            ...
            <el-table-column label="操作" width="250" align="center">
                <template #default="scope">
                    ...
                    <el-popconfirm title="是否删除角色？" confirmButtonText="确认" cancelButtonText="取消"
        ...
        <!-- 权限配置 -->
        <FormDrawer ref="setRuleFormDrawerRef" title="权限配置" @submit="handleSetRuleSubmit" confirm-text="提交">
