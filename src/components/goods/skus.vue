...
const open = (row:any) => {
    ...
    readGoods(goodsId.value).then(res => {
        form.sku_type = (res as any).sku_type
        form.sku_value = (res as any).sku_value || {
            "oprice": 0,
            "pprice": 0,
            "cprice": 0,
            "weight": 0,
...
const submit = () => {
    ...
    let data:{sku_type:any,sku_value:any,goodsSkus?:any} = {
...
<template>
    <FormDrawer ref="formDrawerRef" title="设置商品规格" @submit="submit" destroy-on-close size="70%" confirm-text="提交">
        <el-form :model="form">
